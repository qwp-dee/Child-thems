...
function prfx_meta_callback( $post ) {
   ...
   <div style="margin-bottom:20px; padding: 10px;"> 
	...
	<!-- Image or file, wp-upload image upload  -->
	<p>
    <label for="meta-image" class="prfx-row-title"><?php _e( 'Example File Upload', 'prfx-textdomain' )?></label>
  
    <img src="<?php if ( isset ( $prfx_stored_meta['meta-image'] ) ) echo $prfx_stored_meta['meta-image'][0]; ?>" id="getImage" class="form-control" style="height: 150px; width: 150px;"/>
...
function prfx_color_enqueue() {
    ...
    if( $typenow == 'post' ) {
        ...
        wp_enqueue_script( 'meta-box-color-js', CHI_THEME_URI . 'meta-box-color.js', array( 'wp-color-picker' ) );
    }
}
...
function prfx_image_enqueue() {
    ...
    if( $typenow == 'post' ) {
        ...
        wp_register_script( 'meta-box-image', CHI_THEME_URI . 'wp-media.js', array( 'jquery' ) );
